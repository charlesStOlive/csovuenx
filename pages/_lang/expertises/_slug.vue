    ...
    <v-layout align-space-around justify-center row wrap fill-height>
      <v-flex d-flex sm12 md5>
        <v-card flat dark>
          ...
          <v-card-text>
            <span v-html="$md.render(expertise.description)"/>
            <br>
      ...
      <v-flex d-flex sm12 md4>
        <v-card flat dark>
          ...
          <v-flex v-for="project in expertise.projects" :key="project.id" xs12 pa-4>
            <v-card tile>
              <v-img class="ma-2" :src="project.main_picture.path"></v-img>
