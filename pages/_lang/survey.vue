<template>
  <div>
    <h4 class="pa-4">Un mini formulaire en 3 étapes avec pas plus de dix questions. à la dernière étape cliquez sur terminer.</h4> 
    ...
    <v-stepper-items>
      ...
      <v-stepper-content step="3">
        ...
        >
          ...
          <v-flex xs6 class="text-xs-right" v-if="formSend">
          Merci ! 
        </v-flex>
